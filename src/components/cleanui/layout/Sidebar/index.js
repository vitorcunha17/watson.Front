...
import { Switch, Radio, Select, Slider, Input } from 'antd'
...
const Sidebar = ({
  ...
  return (
    <>
      ...
      >
        <PerfectScrollbar>
          <div className={style.cui__sidebar__inner}>
            ...
            />
            <h5>
              <strong>Personalizar temas</strong>
            </h5>
            <div
            ...
            <div>
                ...
                <div className={style.cui__sidebar__type__items}>
                  ...
                  >
                    <div className="row">
                      <div className="col-6">
                        <div className="mb-2">
                          <Radio value="left">Menu(Esquerda)</Radio>
                        </div>
                        <div className="mb-2">
                          <Radio value="top">Menu(Topo)</Radio>
                        </div>
                      </div>
                      <div className="col-6">
                        <div className="mb-2">
                          <Radio value="nomenu">Sem menu</Radio>
                        </div>
                      </div>
                    </div>
                  </Radio.Group>
              ...
              <div className={`${style.cui__sidebar__type} mb-4`}>
                ...
                <div className={style.cui__sidebar__type__items}>
                  ...
                  >
                    ...
                    <Select.Option value="fadein">Aparecer</Select.Option>
              ...
              <div className={`${style.cui__sidebar__type} mb-2`}>
                <div className={style.cui__sidebar__type__title}>
                  <span>Tamanho do Menu(Esquerda)</span>
                </div>
                <div className={style.cui__sidebar__type__items}>
                  <Slider
                    value={leftMenuWidth}
              ...
              <div className={style.cui__sidebar__item}>
                <div className={style.cui__sidebar__label}>Menu: Cor</div>
                <div className={style.cui__sidebar__container}>
                  <ColorPicker
                    setting="menuColor"
                    value={menuColor}
              ...
              <div className={style.cui__sidebar__item}>
                <div className={style.cui__sidebar__label}>Topbar: Fixo</div>
                <div className={style.cui__sidebar__container}>
                  <Switch
              ...
              <div className={style.cui__sidebar__item}>
                <div className={style.cui__sidebar__label}>Cards: Sombras</div>
                <div className={style.cui__sidebar__container}>
                  <Switch
      ...
      <Tooltip title="Tema noturno / Tema claro" placement="left">
        <a
          role="button"
          tabIndex="0"
          onFocus={e => {
      ...
      <Tooltip title="Ajustar cor" placement="left">
        <a
